...
let allOut = document.getElementById('app__footer-all-out')
let activeOut = document.getElementById('app__footer-active-out')
let completedOut = document.getElementById('app__footer-completed-out')
...
allOut.addEventListener('click', () => TODO.init())
activeOut.addEventListener('click', () => TODO.displayActive())
completedOut.addEventListener('click', () => TODO.displayCompleted())
